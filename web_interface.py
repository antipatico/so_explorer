...
from so_explorer import symbols_summary, symbols_search, symbol_get, sofile_get
...
def search():
	return render_template("template.html", symbols=symbols_search(session, request.form['search']))
